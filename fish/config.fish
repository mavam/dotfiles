...
if status is-interactive
  ...
  abbr -g gc! 'git commit --verbose --amend'
  abbr -g gcn! 'git commit --verbose --amend --no-edit'
  abbr -g gca 'git commit --all --verbose'
  abbr -g gca! 'git commit --all --verbose --amend'
  abbr -g gcan! 'git commit --all --verbose --no-edit --amend'
  abbr -g gcans! 'git commit --all --verbose --signoff --no-edit --amend'
  ...
  abbr -g glp1 'git log --patch --max-count=1'
  abbr -g gm 'git merge'
  ...
  abbr -g gpoatf 'git push origin --all --force && git push origin --tags --force'
  abbr -g gpl 'git pull'
  ...
  abbr -g gsc 'git switch --create'
  abbr -g gsm 'git switch main'
  abbr -g gst 'git switch topic/'
  abbr -g gts 'git tag --sign'

  # Abbreviations: worktrunk
  if command -sq wt
    # Switch (mirrors gs/gsc/gsm)
    abbr -g ws 'wt switch'
    abbr -g wsc 'wt switch --create'
